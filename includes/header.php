...
<body>
    ...
    <header class="header">
        <div class="nav-container">
            ...
            <!-- thanhtimkiem -->
            <form action="../pages/search.php" method="GET" class="search">
                <!-- kinhlup -->
                    ...
                    <?php if(isset($_SESSION['user_id'])): ?>
                        <li class="user-profile" style="position:relative;">
                            ...
                            <div class="dropdown-menu" id="dropdownMenu" style="display:none;">
                                <a href="../songs/favorites.php"><i class="fas fa-heart"></i> Bài Hát Yêu Thích</a>
                                <a href="../songs/my_uploads.php"><i class="fas fa-music"></i> Bài Hát Của Tôi</a>
                                <a href="../songs/upload.php"><i class="fas fa-upload"></i> Upload Nhạc</a>
                                <?php if(isset($_SESSION['username']) && $_SESSION['username'] === 'admin'): ?>
                                    <a href="../admin/approval.php"><i class="fas fa-shield-alt"></i> Duyệt Bài Hát</a>
                                <?php endif; ?>
